...
return [
    ...
    'shelves_drag_books' => 'Drag books below to add them to this category',
    ...
    'shelves_permissions_cascade_warning' => 'Permissions on categories do not automatically cascade to contained books. This is because a book can exist on multiple categories. Permissions can however be copied down to child books using the option found below.',
    ...
    'convert_to_shelf_contents_desc' => 'You can convert this book to a new category with the same contents. Chapters contained within this book will be converted to new books. If this book contains any pages, that are not in a chapter, this book will be renamed and contain such pages, and this book will become part of the new category.',
    'convert_to_shelf_permissions_desc' => 'Any permissions set on this book will be copied to the new category and to all new child books that don\'t have their own permissions enforced. Note that permissions on categories do not auto-cascade to content within, as they do for books.',
